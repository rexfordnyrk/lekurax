...
const EmailLayer = () => {
    return (
                    ...
                    <div className="modal-body p-24">
                        <div className="row gy-16">
                            <div className="col-12">
                                <label className="form-label text-sm mb-8">To</label>
                                <input className="form-control radius-8" placeholder="recipient@example.com" />
                            </div>
                            <div className="col-12">
                                <label className="form-label text-sm mb-8">Subject</label>
                                <input className="form-control radius-8" placeholder="Subject" />
                            </div>
                            <div className="col-12">
                                <label className="form-label text-sm mb-8">Message</label>
                                <textarea className="form-control radius-8" rows={6} placeholder="Write your message..." />
                            </div>
                        </div>
                    </div>
        ...
        {/* Placeholder modals referenced elsewhere in this page */}
        <div className="modal fade" id="exampleModalView" tabIndex={-1} aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content radius-16 bg-base">
                    <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                        <h1 className="modal-title fs-5">View</h1>
                        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
                    </div>
                    <div className="modal-body p-24">Not implemented in theme.</div>
                </div>
            </div>
        </div>
