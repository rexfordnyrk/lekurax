...
const CouriersPage = () => {
  ...
  const onCreate = async (e) => {
    ...
    setError("");
    try {
      await lekuraxFetch("/api/v1/couriers", {
        method: "POST",
        body: {
          name,
          phone: phone || null,
          ...
          <div className='col-lg-4'>
            <div className='card p-24 radius-12'>
              ...
              <div className='small text-muted'>
                Tip: use the search on the right to quickly find couriers by name,
                phone, or ID.
              </div>
            </div>
          </div>
                    ...
                    {filtered.length === 0 ? (
                      <tr>
                        <td colSpan={3} className='text-center text-muted py-4'>
                          {loading ? "Loading…" : "No couriers found"}
                        </td>
                      </tr>
                    ) : null}
                  </tbody>
